...
const FIELDS = [
    'Review__c.Overall_Employee_Comments__c',
    'Review__c.Overall_Manager_Comments__c'
];
...
export default class ReviewComments extends LightningElement {
    ...
    wiredReview({ data }) {
        if (data) {
            this.employeeComments =
                data.fields.Overall_Employee_Comments__c.value || '';

            this.managerComments =
                data.fields.Overall_Manager_Comments__c.value || '';
    ...
    handleSave() {
        ...
        const fields = {
            Id: this.recordId,
            Overall_Employee_Comments__c: this.employeeComments,
            Overall_Manager_Comments__c: this.managerComments
        };
